...
class Cart extends Component {
    ...
    getMyOrder = () => {
        ...
        OrderService.placedOrder(data).then(response => {
    ...
    getDetails = () => {
        ...
        console.log(data);
        AddressService.getDetails(data).then(response => {
            this.setState({
                addressUser:response.data.data
            })
        }).catch((error) => {
            console.log(error)
        })
    ...
    getUserAddress=()=>{
        AddressService.UserDetails().then(response =>{
            console.log(response);
            this.setState({
                addressDetails:response.data.data
            })
        }).catch((error) => {
            console.log(error)
        })
                ...
                <div>
                    ...
                    <Container id="cartcontainer" maxWidth="md">
                        <Card className={cartData.length === 1 ? "bookdiv1" : "bookdiv"} variant="outlined">
                            ...
                            <div className={cartData.length <= 2 ? "scrollbar" : "scrollbar"}>
                                {
                                ...
                                <div className="detailsblock">
                                            ...
                                            cartData.map((books, index) =>
                                                <div key={index}>
                                                    <div className="details-content">
                                                        <div>
                                                            <img src={books.book.bookLogo} alt={"Not found"}
                                                                 className="img"/>
                                                        </div>
                                                        <div className="order-summary-books-div">
                                                            <Typography id="summary-bookname"
                                                                        component="h2">{books.book.bookName}</Typography>
                                                            <Typography variant="body2" color="textSecondary"
                                                                        id="summary-authorname">{books.book.bookAuthor}</Typography>
                                    ...
                                    <div>
                                        ...
                                        <div className="price-main-div">
                                            <b>Total price: </b>
                                            <b className="total-price">Rs.{this.state.totalPrice}</b>
                                        </div>
